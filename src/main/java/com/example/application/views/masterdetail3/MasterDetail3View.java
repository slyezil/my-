package com.example.application.views.masterdetail3;
...
@PageTitle("Master-Detail3")
@Route(value = "master-detail3/:samplePersonID?/:action?(edit)")
@Tag("master-detail3-view")
@JsModule("./views/masterdetail3/master-detail3-view.ts")
@Uses(Icon.class)
public class MasterDetail3View extends LitTemplate implements HasStyle, BeforeEnterObserver {
    ...
    public MasterDetail3View(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("master-detail3-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(MasterDetail3View.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(MasterDetail3View.class);
            }
        }
    }
